...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 05, 2017 at 06:49 PM
...
INSERT INTO `batch` (`s.no`, `batch_no`) VALUES
(3, '2014-2018'),
(5, '2015-2019');
...
INSERT INTO `login_users` (`userid`, `username`, `password`) VALUES
('pmsadmin', 'pmsadmin', 'secepms'),
('secedean', 'dean', '123456'),
('seceprincipal', 'principal', '123456'),
('SECETCS123', 'Arulkumar', '123456');
...
CREATE TABLE `project_details` (
  ...
  `final_prizes_won` text NOT NULL,
  `final_patent` text NOT NULL,
  `final_research` text NOT NULL,
  `final_startup` text NOT NULL,
  `final_stp_details` text NOT NULL,
  `dean_comment` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('PMS-26', '2015-2019', 'eee', 'B', 'Society Oriented', 'yahooo', 'php', '123564', '14567897987', '', 'Rs.3000', '123456', 'good', 'bad', '', '', 'good', '', 'good', 'maxresdefault.jpg', '', 'SECETCS123', 'sada', 'satisfied', '', '465', '', '', '', '', 'nkb', 'asas', '', '', 'sad', '', '', '', '', '', '', '', '');
