...
/*project ID*/
   if(isset($_REQUEST["id"]))
    ...
    if(isset($_REQUEST["add1"]))
    {
        ...
        $review = "UPDATE project_details SET project_status='".$status."',sem2_rev1 = '".$rev1."', sem2_rev1_pic = '".$pic1."',sem2_competition = '".$comp."' , com_one_sem2='".$com."' WHERE proj_id='$pid'";
...
<!--======PHP FOR REVIEW 2===========-->
 <?php
    if(isset($_REQUEST["add2"]))
    {
        ...
        $review = "UPDATE project_details SET sem2_rev2 = '".$rev2."', sem2_rev2_pic = '".$pic2."' , com_two_sem2='".$com."' WHERE proj_id='$pid'";
...
<!--======PHP FOR REVIEW 3===========-->
 <?php
    if(isset($_REQUEST["add3"]))
    {
        ...
        $review = "UPDATE project_details SET sem2_rev3 = '".$rev3."', sem2_rev3_pic = '".$pic3."'  , com_three_sem2='".$com."' WHERE proj_id='$pid'";
                                            ...
                                            <div class="col-sm-10 col-sm-offset-1">
                                             <div class="col-sm-5 col-sm-offset-1">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <textarea class="form-control" type="text" name="status"><?php echo $proj['project_status'] ?></textarea>
                                                    </div>
                                                </div>
                                            <div class="col-sm-5 col-sm-offset-1">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Competition Participated</label>
                                                        <textarea class="form-control" type="text" name="comp"><?php echo $proj['sem2_competition'] ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="picture-container" style="text-align:center">
                                                 ...
                                                 <div class="col-sm-5 col-sm-offset-1">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <textarea class="form-control" type="text" name="com_one" rows="4"><?php echo $proj['com_one_sem2'] ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                       <br>
                                        ...
                                        <form action="#" method="post"> 
                                            ...
                                            <div class="col-sm-10 col-sm-offset-1">
                                                ...
                                                <div class="col-sm-5 col-sm-offset-4">
                                                    ...
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Comment</label>
                                                        <textarea class="form-control" type="text" name="com_two" rows="4"><?php echo $proj['com_two_sem2'] ?></textarea>
                                                    </div>
                                                </div>                                                                                       
                                                <div class="col-sm-5 col-sm-offset-1">
                                                <div class="picture-container" style="text-align:center">
                                    ...
                                    <div class="tab-pane" id="rev3">                                    
                                            ...
                                            <div class="col-sm-10 col-sm-offset-1">
                                                ...
                                                <div class="col-sm-5 col-sm-offset-1">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Comment</label>
                                                        <textarea class="form-control" type="text" name="com_three" rows="4"><?php echo $proj['com_three_sem2'] ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-5 col-sm-offset-1">
                                                <div class="picture-container" style="text-align:center">
