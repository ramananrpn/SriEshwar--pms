...
<body>
   <nav class="mb-1 navbar fixed-top navbar-expand-lg navbar-dark cyan" style="height: 60px;">
...
<iframe height=" auto 100% " width="100%" src="sem2_reviewform.php?id=<?php echo $pid; ?>" name="iframe_a" style="margin-top: 59px; " onload="resizeIframe(this)" ></iframe>
...
<footer class="page-footer" style="background-color: rgba(51, 187, 255,0.6);bottom: 0px;width: 100%;margin-top: -13px;position: fixed;">
