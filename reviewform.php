...
/*project ID*/
   if(isset($_REQUEST["id"]))
    ...
    if(isset($_REQUEST["add0"]))
    {
        ...
        $com_zero = $_POST["com_zero"];
        $zero = $_POST["zero"];

        $review = "UPDATE project_details SET sem1_zero_rev = '".$zero."' , com_zero = '".$com_zero."' WHERE proj_id='$pid'";
...
?>
    ...
    if(isset($_REQUEST["add1"]))
    {
       $file = $_FILES["pic1"]["name"];
        ...
        $pic1=$_POST["pic1"];
        $rev1 =$_POST["rev1"];
		$com_one_sem1 = $_POST["com_one_sem1"];

        $review = "UPDATE project_details SET sem1_rev1 = '".$rev1."', sem1_rev1_pic = '".$file."' , com_one_sem1 = '".$com_one_sem1."' WHERE proj_id='$pid'";
...
<!--======PHP FOR REVIEW 2===========-->
 <?php
    if(isset($_REQUEST["add2"]))
    {
        ...
        $pic2=$_POST["pic2"];
        $rev2 =$_POST["rev2"];
		$com_two_sem1 = $_POST["com_two_sem1"];
        $review = "UPDATE project_details SET sem1_rev2 = '".$rev2."', sem1_rev2_pic = '".$file."' ,com_two_sem1 = '".$com_two_sem1."' WHERE proj_id='$pid'";
...
<!--======PHP FOR REVIEW 3===========-->
 <?php
    if(isset($_REQUEST["add3"]))
    {
        ...
        $pic3=$_POST["pic3"];
        $rev3 =$_POST["rev3"];
        $com_three_sem1 = $_POST["com_three_sem1"];
        $review = "UPDATE project_details SET sem1_rev3 = '".$rev3."', sem1_rev3_pic = '".$file."',com_three_sem1 = '".$com_three_sem1."' WHERE proj_id='$pid'";
                                            ...
                                            <div class="col-sm-10 col-sm-offset-1">										 
                                                ...
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <textarea class="form-control" type="text" name="com_zero" rows="4"></textarea>
                                                    </div>
                                                </div>
